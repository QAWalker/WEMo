...
```{r read-bathy-data-for-show, eval = FALSE, fig.alt="Map showing the bathy raster"}
# load bathymetry
...
```{r bathy-path-hidden, incldue = F, fig.alt = "Map showing Bathymetric raster"}
bathy_path <- system.file("extdata", "PI_bathy.tif", package = "WEMo")

if (bathy_path == "" || !file.exists(bathy_path)) {
  # We search from the project root (top level)
  # This is more reliable than guessing with "../../"
  bathy_path <- pkgload::package_file("inst", "extdata", "PI_bathy.tif")
}
